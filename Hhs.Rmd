...
"here", "emma", "rPref", "evd", "rPref", "emma")
...
For the genotype data, I converted "Dr. Anna run genotypes.xlsx" to the csv file 
...
plot.snp.by.function(all.gene.info, max.fp = max.fp)
```
...
```{r top_ten_funcion, fig.width = 5, fig.height = 10}
num.top.genes <- 20
...
plot.final.results(all.gene.info, snps, genetic.regions, sig.p = 3.7e-6, max.fp = max.fp)
```
